...
5. you can refer tabs with @n directly in chat window.
6. you can save a browser session with a name just by asking it in the chat i.e. save this session as "session-01".
7. form autofill and data entry.
8. real-time Q&A on any page - you can interact with browser and ask questions about the contents on teh page(s) and get answers.
